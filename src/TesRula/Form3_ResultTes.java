 ...
 */
public final class Form3_ResultTes extends javax.swing.JFrame {
    ...
    public void HasilTabelB(){ 
        try{
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()){
                int location_neck = res.getInt("neck");
                int locate_trunk = res.getInt("trunk");
                int legs = res.getInt("leg");
    ...
    public void HasilTabelC(){ 
        try{
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()){
                int armmuscle = res.getInt("armmuscle");
                int legmuscle = res.getInt("legmuscle");
                int scoreTableA = Integer.parseInt(ScoreA.getText());
                int scoreTableB = Integer.parseInt(ScoreB.getText());
                
                int wristArmScore = scoreTableA + armmuscle;
                int neckTrunkLegsScore = scoreTableB + legmuscle;
    ...
    public Form3_ResultTes() {
        ...
        try {
            ...
            String simpan = "UPDATE t_rula SET final_score ='" + ScoreFinal.getText() + "' WHERE nim='" + Form1_InputDataTes.NimTxt.getText()+"'";
    ...
    private void initComponents() {
        ...
        jPanel1.add(LabelScoreAkhir, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 1022, -1));
        ...
        PanelLihatRingkasanLengkap.setBackground(new java.awt.Color(191, 204, 181));
        ...
        jPanel1.add(PanelLihatRingkasanLengkap, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 280, 270, 40));
        ...
        jPanel1.add(TitelPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1040, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form3_ResultTes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
